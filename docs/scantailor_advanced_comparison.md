...
Текущая quality-first политика не исключает GPL или другие семейства лицензий из сравнения.
Лицензия фиксируется отдельно и влияет на обязательства/способ поставки, но не на оценку качества.
...
- Прямое портирование GPL-классов потребует явного изменения лицензирования соответствующей
  поставки и выполнения условий GPL. Текущая реализация остаётся независимой.
...
- Автоматический выбор между text-line, UVDoc и дополнительными backends любых лицензий;
